        ...
        <div className="space-y-5 max-w-6xl mx-auto text-zinc-900 dark:text-white">
            ...
            <div className="flex max-md:flex-col gap-4 flex-wrap items-start justify-between max-w-6xl">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-sm rounded bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300 hover:bg-purple-200 dark:hover:bg-purple-900/50 transition-colors"
                >
                    <div className="relative">
                        <ZapIcon className="size-4 absolute blur-sm opacity-50" />
            ...
            {showAIGenerator && <AITaskGenerator showAIGenerator={showAIGenerator} setShowAIGenerator={setShowAIGenerator} projectId={id} members={project.members} />}
        </div>
    );
}
